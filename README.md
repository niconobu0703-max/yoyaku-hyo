...
const SETTINGS_KEY =
 "yoyaku_settings_final_v7";

const RES_PREFIX =
 "yoyaku_reservations_final_v7_";
  ...
  .forEach(button=>{
   ...
   button.onclick=()=>{
    ...
    settings.courses.splice(
     Number(button.dataset.rmcourse),
     1
    );
